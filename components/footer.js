      ...
      <div className="absolute w-full bottom-[17vh] z-10 flex justify-around text-white text-[2.4vh]">
        <div className="flex flex-row gap-[10vh] lg:gap-[32vh]">
          ...
          <div className="flex flex-col">
            ...
            <p className="cursor-pointer" onClick={() => window.open("mailto:principal@bbit.ac.in")}
            >principal@bbit.ac.in</p>
          </div>
          <div className="flex flex-col">
            <h3 className="font-bold">Follow Us On:</h3>
            <div className="flex gap-[2vh] mt-[1.5vh] -ml-[3vh] ">
              <img className="w-[2vw] h-[4vh]" src="/footer_images/instagram.svg" alt="Instagram" />
              <img className="w-[2vw] h-[4vh]" src="/footer_images/linkedin.svg" alt="LinkedIn" />
              <img className="w-[2vw] h-[4vh]" src="/footer_images/twitter.svg" alt="Twitter" />
              <img className="w-[2vw] h-[4vh]" src="/footer_images/facebook.svg" alt="Facebook" />
            </div>
          </div>
        </div>
      </div>
