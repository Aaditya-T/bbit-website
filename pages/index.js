      ...
      <div className="container">
        ...
        <div className="content">
          <div className="vision">
            <h2>OUR VISION</h2>
            <p>
              At BBIT College, we are guided by a set of core values that shape our approach to education and community engagement. These values are the foundation upon which we build transformative learning experiences.
            </p>
          </div>
